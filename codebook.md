...
That code takes the standard deviation and mean features from the original accelerometer data, and finds the mean over each subject and activity (as fields 3-68), grouped over subject and activity.  
